...
class ProtegoNode:
    def __init__(self, node: Node):
        ...
        self.text: str = node.text.decode() # .decode is added from khaled
        self.original_node: Node = node   # Added from Anas
...
class ProtegoTree:
    def __init__(self, tree: Tree, file_name: str = None, full_file_path: str = None):
        # TODO: Delete this
